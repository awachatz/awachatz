...
trait PaypalCheckout
{
    ...
    public function paypalNotify($responseData){
        ...
        if ($result->getState() == 'approved') {
			...
			$adminEmailData = [
                'to' => 'info@awachatz.com',
                'subject' => "Awachatz: A new order has been placed",
                'body' => "<p>Hello Admin,</p>
						  <p>Awachatz: A new order has been placed.<br>You can track the order in the admin by transaction Number: $order->transaction_number.<br>
						   Order Amount : $total_amount<br>
					    	</p>
						   Thanks,<br>
						   Awachatz.com",
            ...
            $Adminemail = new EmailHelper();
            $Adminemail->sendCustomMail($adminEmailData);
			
			$adminEmailData = [
                'to' => 'anywhereanycity@gmail.com',
                'subject' => "Awachatz: A new order has been placed",
                'body' => "<p>Hello Admin,</p>
						  <p>Awachatz: A new order has been placed.<br>You can track the order in the admin by transaction Number: $order->transaction_number.<br>
						   Order Amount : $total_amount<br>
