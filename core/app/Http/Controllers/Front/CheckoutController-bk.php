...
class CheckoutController extends Controller
{
	...
	public function ship_address()
	{
        ...
        */
        ...
        /**
         **      check percentage or fixed tax
        **/
       $statePrice = 0;
       $state_tax = 0;
       if( Auth::check() ) {
        $statePrice= Auth::user()->state->type == 'percentage' ? $cart_total*Auth::user()->state->price/100 : Auth::user()->state->price;
        $state_tax = Auth::check() && Auth::user()->state_id ? $statePrice : 0;
       }
