      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          ...
          <section class="widget widget-light-skin">
            ...
            <div class="content">
            <p class="info"></p><h3 style="color: #000;padding-bottom:10px;"> Looking for help?</h3>
            <ul class="contact_info_list">
             <li class="single-info-item">
                                ...
                                <div class="details">
                                  ...
                                  <a style="color: #000;" href="https://www.awachatz.com/support/" target="_blank">Support</a>
                                </div>
                            </li>
             </ul><p></p>
                    </div>
          ...
          @endphp
            <div class="footer-social-links">
                ...
                @endforeach
                <a href="https://www.tiktok.com/@awachatz"><span><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" style="
    font-size: 14px;
"><path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"></path></svg></span></a>
            </div>
          </section>
        </div>
