      ...
      <div class="col-xl-9 col-lg-8">
        <div class="steps flex-sm-nowrap mb-5"> 
          <a class="step" href="{{route('front.checkout.billing')}}">
            <h4 class="step-title">
              <i class="icon-check-circle"></i>1. {{__('Invoice to')}}:
            </h4>
          </a> 
          <a class="step" href="{{route('front.checkout.shipping')}}">
            <h4 class="step-title">
              <i class="icon-check-circle"></i>2. {{__('Ship to')}}:
            </h4>
          </a> 
          ...
          <div class="card-body">
            ...
            <div class="row padding-top-1x  mb-4">
              ...
              <div class="col-sm-6">
                ...
                <select name="shipping_service_id" class="form-control" id="shipping_service_id_select" required>
                    <option value="1" data-href="{{route('front.shipping.rate', ['code' => '1'])}}" {{Session::has('shippingServiceCode') ? (Session::get('shippingServiceCode') == '1' ? 'selected':''):'selected'}}>Retail Ground</option>
                    <option value="2" data-href="{{route('front.shipping.rate', ['code' => '2'])}}" {{Session::has('shippingServiceCode') && Session::get('shippingServiceCode') == '2' ? 'selected':''}}>Priority Mail</option>
                </select>
