...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
		...
		// Contact messages
        Route::get('contact-messages', 'Back\ContactController@index')->name('back.contactus.list');
        Route::delete('contact-messages/{id}', 'Back\ContactController@delete')->name('back.contactus.destroy');
        ...
        Route::group(['middleware' => 'permissions:Manage Categories'], function () {
            ...
            //------------ Shiment Boxes ------------
            Route::resource('box', 'Back\BoxController', ['as' => 'back', 'except' => 'show']);
        });
        ...
        Route::group(['middleware' => 'permissions:Manage Site'], function () {
            ...
            Route::get('/sitemap/refresh', 'Back\SitemapController@generateSiteMap')->name('admin.sitemap.refresh');
    ...
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::prefix('user')->group(function () {
            ...
            Route::get('/profile', 'User\AccountController@profile')->name('user.profile');
			  Route::get('/loginstatus', 'User\AccountController@profile')->name('user.loginstatus');
        ...
        Route::get('/ups/shipping-rate/{code}', 'Front\CheckoutController@shippingSetup')->name('front.shipping.rate');
